...
const SideBar = () => {
  ...
  return (
    <div
      ...
      className={`dlabnav ${path === "dashboard" || path === "index-2" ? 'follow-info' : ''} ${iconHover} ${
          ...
          <div className="menu-scroll">
              <div className="dlabnav-scroll">
                ...
                <div className="copyright">
                    <p><strong>Blaze</strong> © <span className="current-year">{Latest.getFullYear()}</span> All Rights Reserved</p>
