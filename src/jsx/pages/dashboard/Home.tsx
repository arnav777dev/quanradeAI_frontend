	...
	return(
		<Row>
			<Col xl={12}>			
				...
				<div style={{margin: '12px -13px 0px -12px'}}>
					<Portofolio/>
				</div>
			</Col>
		</Row>
                        ...
                        <div className="card-body">
                            <div className="text-center my-profile">
                                <div className="media d-block">
                                    ...
                                    <h3 className="mt-3 font-w800 text-dark">{userName?.first_name +" "+userName?.last_name}</h3>
                                    <span>{userName?.email}</span>
                                </div>
                                <div className="media-content">
                                    <h4 className="mt-3 font-w400 fs-16 text-dark mb-0">Join on {dayjs(userName?.date_joined).format('MM-DD-YYYY')}</h4>
