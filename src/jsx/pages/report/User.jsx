                                    ...
                                    <div className="w-100 ps-4">
                                        ...
                                        <div className="d-flex flex-wrap pt-4">
                                            ...
                                            <div className="d-flex align-items-center pe-md-4 pe-2 mb-2">
                                                ...
                                                <h5 className="font-w400 mb-0">Blaze Studios</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
									...
									<div className="dz-scroll">
										<ul className="timeline-active">
											<li className="d-flex timeline-list">
												...
												<div className="panel">
													<Link to={"#"} className="timeline-panel text-muted d-flex align-items-center mb-0">
														<h4 className="mb-0"><strong>Karen Hope</strong> moved task <strong className="text-primary">Blaze Projects</strong> </h4>
													</Link>
											...
											<li className="d-flex timeline-list">
												...
												<div className="panel">
													<Link to={"#"} className="timeline-panel text-muted d-flex align-items-center mb-0">
														<h4 className="mb-0" ><strong>Tony Soap </strong> commented at <strong className="text-primary"> Blaze Projects </strong></h4>
													</Link>
													<span className="time py-0">Monday, June 31 2020</span>	
											...
											<li className="d-flex timeline-list pb-0">
												...
												<div className="panel">
													<Link to={"#"} className="timeline-panel text-muted d-flex align-items-center mb-0">
														<h4 className="mb-0" ><strong>Samantha William </strong> add 4 files on  Blaze <strong className="text-danger">Projects </strong></h4>
													</Link>
													<span className="time py-0">Monday, June 31 2020</span>	
												</div>
