...
let ws: WebSocket | null = null;
  ...
  const App = () => {
    ...
    useEffect(() => {
      if (!hasFetchedRef.current) {
        ...
        const fetchPaginatedData = async () => {
          setLoading(true);
          try {
            // const response = await axios.get('https://api.quantradeai.com/strategy/orders/search/?paginate=true&clear_cache=false',{headers});
            console.log("page index ",pagination.pageIndex)
            const response = await axios.get('https://api.quantradeai.com/strategy/orders/search/', {
              params: {
    ...
    }, [headers, pagination.pageIndex]); // Empty dependency array means this effect runs once (componentDidMount)
